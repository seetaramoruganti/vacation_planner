1. in this project, we discussed the effects of not using use effect which leads to infinite rendering of components example the app component runs every time when the location is fetched.
